...
require('headerA.php');
    ...
    <body class="color-theme-blue mont-font">
        ...
        <div class="main-wrapper">
            ...
            <form action="modifierU.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="middle-sidebar-left">
                        <div class="middle-wrap">
                            ...
                            <div class="card-body p-4 w-100 bg-current border-0 d-flex rounded-3">
                                    ...
                                    <h4 class="font-xs text-white fw-600 ms-4 mb-0 mt-2">Modifier l'utilisateur</h4>
                                </div>
                                <div class="card-body p-lg-5 p-4 w-100 border-0 ">
                                <div class="row justify-content-center">
                                    <div class="col-lg-4 text-center">
                                        <figure class="avatar ms-auto me-auto mb-0 mt-2 w180"><img src="images/<?php echo $photo ?>" alt="image" class="shadow-sm rounded-3 w-100"></figure>
                                        <h2 class="fw-700 font-sm text-grey-900 mt-3"><?php echo $nom ?></h2>
                                        <h4 class="text-grey-500 fw-500 mb-3 font-xsss mb-4"><?php echo $email ?> </h4>    
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo $prenom ?>" name="prenom" class="form-control">
                                            </div>        
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <input type="file" name="photo" id="photo" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="image">
